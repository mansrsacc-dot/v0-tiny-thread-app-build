...
export const T: Record<Lang, Record<string, string>> = {
  lv: {
    ...
    front: "Priekša",
    back: "Aizmugure",
    viewLocked: "Pabeidz vai atceļ pašreizējo dizainu, lai mainītu skatu",
    size: "Izmērs",
    style: "Stils",
    price: "Cena",
    ...
    cartOverlayTitle: "Pievienojam grozam...",
    cartOverlaySubtitle: "Lūdzu, neaizver šo logu",
    ...
    errorImageUpload: "Attēla augšupielāde neizdevās",
    errorImageUploadDesc: "Neizdevās saglabāt tavu dizainu. Lūdzu, mēģini vēlreiz.",
    error: "Kļūda",
    quantity: "Daudzums",
    ...
    regenTooltip: "Cita ģenerācija (Jūs varēsiet izvēlēties starp visām Jūsu ģenerācijām).",
    ...
    capQtyLabel: "Cik cepures?",
    capOneSize: "Viens izmērs",
    dupDiscountNote: "Katrs nākamais identiskais izstrādājums −35%",
  ...
  en: {
    ...
    front: "Front",
    back: "Back",
    viewLocked: "Finish or cancel the current design to switch views",
    size: "Size",
    style: "Style",
    price: "Price",
    ...
    cartOverlayTitle: "Adding to cart...",
    cartOverlaySubtitle: "Please don't close this window",
    inclBack: "incl. back",
    ...
    errorImageUploadDesc: "Couldn't save your design. Please try again.",
    error: "Error",
    quantity: "Quantity",
    garmentSize: "Garment Size",
    garmentSizeHint: "Choose your hoodie size",
    ...
    regenTooltip: "New generation (You will be able to choose between all your generations).",
    ...
    capQtyLabel: "How many caps?",
    capOneSize: "One size",
    dupDiscountNote: "Each additional identical item −35%",
