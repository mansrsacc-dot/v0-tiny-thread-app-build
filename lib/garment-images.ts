...
// VISUAL-ONLY multiplier: rescales the preview so a design matches its real proportion of the
// per-garment-size zone (narrower zone → same mm looks bigger). Exactly 1.0 for M and L.
export const zoneRenderScale = (garmentSize: string): number =>
