  ...
  try {
    ...
    if (style === "outline") {
      if (garmentColor === "black") {
        prompt = "make closest objects (humans,dogs,cars) whichever are most significant to picture to outlined picture with only thick bold white thread on plain black background. not to many lines. remove lines from face keep only outer silhouette of face features. maximum 8 clean bold lines per subject. like a one-line tattoo with thick visible lines. no hoodie no clothing no background objects just the subjects on solid black. no stray lines. no horizontal lines. no ground lines. no base lines. only draw the actual subject shape nothing else. lines must be thick and clearly visible.";
      } else {
        prompt = "make closest objects (humans,dogs,cars) whichever are most significant to picture to outlined picture with only thick bold black thread on plain white background. not to many lines. remove lines from face keep only outer silhouette of face features. maximum 8 clean bold lines per subject. like a one-line tattoo with thick visible lines. no hoodie no clothing no background objects just the subjects on solid white. no stray lines. no horizontal lines. no ground lines. no base lines. only draw the actual subject shape nothing else. lines must be thick and clearly visible.";
      }
